...
export const REQUIRED_ELEMENTS = {
  ...
  // The bulk-edit modal for editing multiple selected channels at once.
  bulkEditModalEl: "#bulk-edit-modal",
  bulkEditFormEl: "#bulk-edit-form",
  bulkEditTitleEl: "#bulk-edit-title",
  bulkEditMessageEl: "#bulk-edit-message",
  bulkEditGridEl: "#bulk-edit-grid",
  bulkEditCancelEl: "#bulk-edit-cancel",
  bulkEditApplyEl: "#bulk-edit-apply",
