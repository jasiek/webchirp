...
export const REQUIRED_ELEMENTS = {
  ...
  rsgbModalEl: "#rsgb-modal",
  rsgbFormEl: "#rsgb-form",
  rsgbBandListEl: "#rsgb-band-list",
  rsgbModeListEl: "#rsgb-mode-list",
  rsgbOnlyOperationalEl: "#rsgb-onlyoperational",
  rsgbLatitudeEl: "#rsgb-latitude",
  rsgbLongitudeEl: "#rsgb-longitude",
  rsgbLocatorEl: "#rsgb-locator",
  rsgbRadiusEl: "#rsgb-radius",
  rsgbGeolocateEl: "#rsgb-geolocate",
  rsgbCancelEl: "#rsgb-cancel",
