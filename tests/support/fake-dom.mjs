...
export const UI_STUBBED_SELECTORS = new Map([
  ...
  ["#radio-search", "input"],
  ["#use-quansheng-drivers", "a"],
  ["#use-chirp-drivers", "a"],
  ["#sidebar-warning", "section"],
  ["#standard-driver-warning", "p"],
  ...
  ["#channel-bulk-edit", "button"],
  ["#channel-extra-form", "form"],
  ["#channel-extra-cancel", "button"],
  ["#channel-extra-save", "button"],
  ["#channel-bulk-edit-form", "form"],
  ["#channel-bulk-edit-cancel", "button"],
